  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Gaussian Splatting専用カラーパレット
        gs: {
          primary: "#6366f1", // インディゴ - メインブランドカラー
          secondary: "#8b5cf6", // バイオレット - アクセントカラー
          accent: "#06b6d4", // シアン - ハイライト
          success: "#10b981", // エメラルド - 成功状態
          warning: "#f59e0b", // アンバー - 警告状態
          error: "#ef4444", // レッド - エラー状態
          neutral: {
            50: "#f8fafc",
            100: "#f1f5f9",
            200: "#e2e8f0",
